      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          for (let knife of Game.arrayKnife) {
            ...
            knife.setPosition(new Vec3(this.spriteWood.position.x + r * Math.cos(rad), this.spriteWood.position.y + r * Math.sin(rad), knife.position.z));
          }
        }
...
//# sourceMappingURL=e7a2aeeda6b416668b08c65fe288ac57ccd5ba03.js.map