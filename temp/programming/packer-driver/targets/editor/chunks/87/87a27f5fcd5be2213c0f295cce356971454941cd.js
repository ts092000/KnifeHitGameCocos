System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'Node', 'tween', 'Vec3', 'instantiate', 'director', 'Label']);
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          for (let knife of Game.arrayKnife) {
            ...
            knife.setPosition(new Vec3(knifeX, knifeY, 0.5)); // this.spriteKnife.setPosition(Game.defaultSpriteKnife);
          }
        }
        ...
        knifeThrow() {
          if (Game.canThrow) {
            ...
            spriteKnifeMove.sequence(spriteKnifeMove, spriteKnifeMove.call(() => {
              let gap = 15;
              let isHit = false;
...
//# sourceMappingURL=87a27f5fcd5be2213c0f295cce356971454941cd.js.map