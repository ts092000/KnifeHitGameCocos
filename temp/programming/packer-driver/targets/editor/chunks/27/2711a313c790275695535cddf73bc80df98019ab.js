          ...
          if (Game.canThrow) {
            ...
            let spriteKnifeMove = tween(this.spriteKnife).to(0.25, {
              ...
              if (isHit) {
                ...
                this.updateScore(); // console.log(this.spriteKnife.position);

                Game.canThrow = true;
              }
            });
            spriteKnifeMove.removeSelf().start();
...
//# sourceMappingURL=2711a313c790275695535cddf73bc80df98019ab.js.map