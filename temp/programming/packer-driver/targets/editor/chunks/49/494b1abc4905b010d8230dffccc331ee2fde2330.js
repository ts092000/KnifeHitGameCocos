  ...
  return {
    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          this.spriteWood.angle = (this.spriteWood.angle + Game.spriteWoodRotation) % 360; // for (let knife of Game.arrayKnife) {
        ...
        knifeThrow() {
          if (Game.canThrow) {
            ...
            spriteKnifeMove.sequence(spriteKnifeMove, spriteKnifeMove).start();
          }
        }
...
//# sourceMappingURL=494b1abc4905b010d8230dffccc331ee2fde2330.js.map