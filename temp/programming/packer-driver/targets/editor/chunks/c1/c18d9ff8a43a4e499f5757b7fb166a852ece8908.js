      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          for (let knife of Game.arrayKnife) {
            ...
            knife.setPosition(new Vec3(this.spriteWood.position.x + r * Math.cos(rad), this.spriteWood.position.y + r * Math.sin(rad), 0));
          }
        }
...
//# sourceMappingURL=c18d9ff8a43a4e499f5757b7fb166a852ece8908.js.map