      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          for (var knife of Game.arrayKnife) {
            ...
            knifeY = this.knife.setPosition(new Vec3(this.spriteWood.position.x + r * Math.cos(rad), this.spriteWood.position.y + r * Math.sin(rad), 0));
          }
        }
...
//# sourceMappingURL=722c41c1cd80ccc26b5d9080c68183080ab47d4a.js.map