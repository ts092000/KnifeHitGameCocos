  ...
  return {
    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        knifeThrow() {
          if (Game.canThrow) {
            Game.canThrow = false; // this.spriteKnife.setPosition(Game.defaultSpriteKnife);

            var spriteKnifeMove = tween(this.spriteKnife).to(0.25, {
              position: new Vec3(this.spriteWood.position.x, this.spriteWood.position.y - 239, 0)
            }).call(() => {
              var gap = 15;
              var isHit = false;
              ...
              if (isHit) {
                ...
                this.updateScore(); // this.spriteKnife.setPosition(Game.defaultSpriteKnife);

                console.log(this.spriteKnife.position);
                this.spriteKnife.active = true;
                this.spriteKnife.setPosition(Game.defaultSpriteKnife);
                console.log(this.spriteKnife.position);
                console.log(Game.defaultSpriteKnife); // console.log(this.spriteKnife.position);
...
//# sourceMappingURL=ba622cb1dbecbedc8cf658ea61a4267f174c12d8.js.map