        ...
        knifeThrow() {
          if (Game.canThrow) {
            ...
            tween(this.spriteKnife).to(0.5, {
              position: new Vec3(this.spriteWood.position.x, this.spriteWood.position.y - this.spriteWood.scale.y / 2, this.spriteWood.position.z)
            }).call(() => {}).start();
          }
        }
...
//# sourceMappingURL=993495cfea80fc19a51847ae4e5cc654eb063406.js.map