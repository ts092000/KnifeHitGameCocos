          ...
          if (Game.canThrow) {
            ...
            var spriteKnifeMove = tween(this.spriteKnife).to(0.25, {
              ...
              if (isHit) {
                ...
                this.updateScore();
                this.spriteKnife.setPosition(new Vec3(0, this.spriteKnife.position.y, this.spriteKnife.position.z));
...
//# sourceMappingURL=522a76dc8620676bff7bbc51a2b034511454b95d.js.map