      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          for (var knife of Game.arrayKnife) {
            ...
            knifeY = this.spriteWood.position.y + 322 * Math.sin(rad); // knife.setPosition(new Vec3(this.spriteWood.position.x + r * Math.cos(rad), this.spriteWood.position.y + r * Math.sin(rad), 0));
          }
        }
...
//# sourceMappingURL=6e66019664162af324b2e4292fe85dbe334eb735.js.map