      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          for (var knife of Game.arrayKnife) {
            ...
            knifeX = this.spriteWood.position.x + 350 * Math.cos(rad);
            knifeY = this.spriteWood.position.y + 350 * Math.sin(rad);
...
//# sourceMappingURL=03878a845f6461024b65590c8e653e9b883e1cc9.js.map