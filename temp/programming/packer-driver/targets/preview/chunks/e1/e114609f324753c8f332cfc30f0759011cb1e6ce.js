  ...
  return {
    ...
    execute: function () {
      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        onLoad() {
          Game.canThrow = true;
          var zIndexKnife = this.spriteKnife.getPosition().z;
          var zIndexWood = this.spriteWood.getPosition().z;
          zIndexKnife = 0;
          zIndexWood = 1;
...
//# sourceMappingURL=e114609f324753c8f332cfc30f0759011cb1e6ce.js.map