      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          for (var knife of Game.arrayKnife) {
            ...
            knife.setPosition(new Vec3(this.spriteWood.position.x + r * Math.cos(rad), this.spriteWood.position.y + r * Math.sin(rad), this.spriteWood.position.z));
          }
        }
...
//# sourceMappingURL=9e00fa0b4540b5aa821788939813b4e93f8ba40a.js.map