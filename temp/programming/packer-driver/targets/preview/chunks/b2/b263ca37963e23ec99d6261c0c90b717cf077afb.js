        ...
        knifeThrow() {
          if (Game.canThrow) {
            ...
            var spriteKnifeMove = tween(this.spriteKnife).to(0.25, {
              position: new Vec3(this.spriteWood.position.x, this.spriteWood.position.y - 239, 1)
            }).call(() => {
              var gap = 15;
              var isHit = false;
              ...
              if (isHit) {
                ...
                this.spriteKnife.active = true; // console.log(this.spriteKnife.position);
...
//# sourceMappingURL=b263ca37963e23ec99d6261c0c90b717cf077afb.js.map