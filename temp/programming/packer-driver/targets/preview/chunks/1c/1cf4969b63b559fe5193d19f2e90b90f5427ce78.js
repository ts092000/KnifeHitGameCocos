      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          for (var knife of Game.arrayKnife) {
            ...
            var knifeY = knife.position.y;
            knifeX = this.spriteWood.position.x + r * Math.cos(rad);
            knifeY = this.spriteWood.position.y + r * Math.sin(rad);
            knife.setPosition(new Vec3(knifeX, knifeX, knife.position.z - 1));
          }
        }
        ...
        knifeThrow() {
          if (Game.canThrow) {
            ...
            var spriteKnifeMove = tween(this.spriteKnife).to(0.25, {
              ...
              this.node.addChild(knifeNode); // Game.arrayKnife.push(knifeNode);
...
//# sourceMappingURL=1cf4969b63b559fe5193d19f2e90b90f5427ce78.js.map