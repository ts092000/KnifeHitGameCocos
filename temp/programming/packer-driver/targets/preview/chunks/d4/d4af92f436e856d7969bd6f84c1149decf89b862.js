      ...
      _export("Game", Game = (_dec = ccclass('Game'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          for (var knife of Game.arrayKnife) {
            ...
            knifeY = this.spriteWood.position.y + 239 * Math.sin(rad); // knife.setPosition(new Vec3(knifeX, knifeY, 0.5));
          }
        }
...
//# sourceMappingURL=d4af92f436e856d7969bd6f84c1149decf89b862.js.map